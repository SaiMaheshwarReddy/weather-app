...
export const FORECAST = ({ lat, long }: { lat: number; long: number }) =>
  `https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${long}&forecast_days=5&hourly=temperature_2m,relativehumidity_2m,pressure_msl,surface_pressure,visibility&daily=temperature_2m_max,temperature_2m_min,windspeed_10m_max,winddirection_10m_dominant&current_weather=true&windspeed_unit=mph&timezone=auto`;
